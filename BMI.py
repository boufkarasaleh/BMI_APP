...
elif BMI_result >= 18.5: # Over 18.5 but below 25 they have a normal weight
    print(f"your BMI is {BMI_result}, you have a normal weight")
elif BMI_result >= 25: # Over 25 but below 30 they are overweight
    print(f"your BMI is {BMI_result}, you are overweight")
elif BMI_result >= 30: # Over 30 but below 35 they are obese
